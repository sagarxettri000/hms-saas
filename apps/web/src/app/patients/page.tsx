      ...
      <ModulePage
        ...
        fields={[
          ...
          { name: 'patientType', label: 'Patient type', type: 'select', options: PATIENT_TYPES, defaultValue: 'GENERAL' },
          {
            ...
            type: 'select',
            optionsFrom: { endpoint: '/doctors', valueKey: 'id', labelKeys: ['user.firstName', 'user.lastName'], emptyValue: '' },
            hint: 'Opens an OPD visit under this doctor — the patient appears in their “My Patients” list.',
          },
          { name: 'chiefComplaint', label: 'Chief complaint (optional)', full: true },
