...
import { BLOOD_COMPONENTS, BLOOD_GROUPS } from '@/lib/options';
      ...
      tabs={[
        {
          ...
          fields: [
            ...
            { name: 'bloodGroup', label: 'Blood group', required: true, type: 'select', options: BLOOD_GROUPS },
        ...
        },
        {
          ...
          columns: [
            ...
            { key: 'donor', label: 'Donor', render: (r) => r.donor?.name || '—' },
          ...
          fields: [
            ...
            { name: 'expiryDate', label: 'Expiry date', type: 'date', hint: 'Defaults to 35 days from collection when left empty' },
